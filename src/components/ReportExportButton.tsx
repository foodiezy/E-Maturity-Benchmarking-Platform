...
export default function ReportExportButton({ assessment, dimensionScores, overallAvg }: any) {
  ...
  return (
    <button 
      ...
      className="flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-2.5 rounded-xl font-bold transition-all shadow-md hover:shadow-lg hover:-translate-y-0.5"
    >
